...
class WebstackClient(object):
    ...
    def Backup(self, saveconfig=True, savemedia=True, backupscenepks=None, backupSceneFormat=None, saveapps=True, saveitl=True, savedetection=False, savestate=True, savecalibration=False, savedebug=False, saveeds=True, saveiodd=True, timeout=600):
