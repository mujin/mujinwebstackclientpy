...
# GENERATED AGAINST: mujinwebstack/3.4.1+a43bd19a40608dc3529686bfa31f75edb0fa59e6
#
...
class GraphQueries:
    ...
    def CommandProductionCycleOrchestrator(
        ...
        Returns:
            CommandProductionCycleOrchestratorQueries:
        """
        parameterNameTypeValues: List[Tuple[str, str, Any]] = [
            ('orchestratorId', 'String!', orchestratorId),
        ]
        return self._CallSimpleGraphAPI('query', operationName='CommandProductionCycleOrchestrator', parameterNameTypeValues=parameterNameTypeValues, returnType='CommandProductionCycleOrchestratorQueries', fields=fields, timeout=timeout)
    ...
    def ConfigureSensorBridgesEx(
        ...
        Returns:
            ConfigureSensorBridgesExQueries:
        """
        parameterNameTypeValues: List[Tuple[str, str, Any]] = []
        return self._CallSimpleGraphAPI('query', operationName='ConfigureSensorBridgesEx', parameterNameTypeValues=parameterNameTypeValues, returnType='ConfigureSensorBridgesExQueries', fields=fields, timeout=timeout)
    ...
    def GetConfiguration(
        ...
        Args:
            configurationId (str): ID of the configuration, for example "controllersystem.conf".
            resolveReferences (bool, optional): Whether to operate on resolved configurations. Defaults to operate and return unresolved data.
            revisionId (int, optional): If supplied, will return the configuration at this revision.
            fields (list or dict, optional): Specifies a subset of fields to return.
            timeout (float, optional): Number of seconds to wait for response.
    ...
    def GetDebugResource(
        ...
        """Get the debug resource by id.

        Args:
            debugResourceId (str): DebugResourceID of the debug resource.
            endedAt (DateTime, optional): The end of the time range for the query. If provided, the results will only include debug resources produced before this timestamp.
            startedAt (DateTime, optional): The start of the time range for the query. If provided, the results will only include debug resources produced after this timestamp.
            fields (list or dict, optional): Specifies a subset of fields to return.
            timeout (float, optional): Number of seconds to wait for response.

        Returns:
            DebugResource: DebugResource for the frontend.
        """
        parameterNameTypeValues: List[Tuple[str, str, Any]] = [
            ('debugResourceId', 'String!', debugResourceId),
            ('endedAt', 'DateTime', endedAt),
            ('startedAt', 'DateTime', startedAt),
        ]
        return self._CallSimpleGraphAPI('query', operationName='GetDebugResource', parameterNameTypeValues=parameterNameTypeValues, returnType='DebugResource', fields=fields, timeout=timeout)
    ...
    def GetLogEntry(
        ...
        Returns:
            LogEntry: An entry in the logs. The current parent-children level relationship among log entry types:
                    ...
                    ├─ WarehouseExecutionScheduleReportLogEntry
                    │  ├─ WarehouseExecutionScheduleReportSegmentLogEntry
                    │  └─ WarehouseExecutionScheduleReportFinishedLogEntry
                    ...
                    ├─ BackupRestoreFinishedLogEntry
                    │  └─ MigrationFinishedLogEntry
                    └─ GraspSetLogEntry
                    ```
        """
        parameterNameTypeValues: List[Tuple[str, str, Any]] = [
    ...
    def GetUntypedConfigurationRevision(
        self,
        configurationId: str,
        revisionId: int,
        resolveReferences: bool = False,
        ...
        """Get a particular revision of a configuration with untyped forward and backward configurations.
        ...
        Returns:
            UntypedConfigurationRevision: revision of a configuration with untyped forward and backward configurations.
        """
        parameterNameTypeValues: List[Tuple[str, str, Any]] = [
            ('configurationId', 'String!', configurationId),
            ('revisionId', 'Int!', revisionId),
        ...
        return self._CallSimpleGraphAPI('query', operationName='GetUntypedConfigurationRevision', parameterNameTypeValues=parameterNameTypeValues, returnType='UntypedConfigurationRevision', fields=fields, timeout=timeout)
    ...
    def ListDebugResources(
        ...
        return self._CallSimpleGraphAPI('query', operationName='ListDebugResources', parameterNameTypeValues=parameterNameTypeValues, returnType='ListDebugResourcesReturnValue', fields=fields, timeout=timeout)
    ...
    @UseLazyGraphQuery
    def ListUntypedConfigurationRevisions(
        self,
        configurationId: str,
        options: Optional[Any] = None,
        resolveReferences: bool = False,
        ...
        """list revisions of a configuration with untyped forward and backward configurations.
        ...
        Returns:
            ListUntypedConfigurationRevisionsReturnValue:
        """
        parameterNameTypeValues: List[Tuple[str, str, Any]] = [
            ('configurationId', 'String!', configurationId),
            ('options', 'ListOptionsWithAggregationsInput', options),
        ...
        return self._CallSimpleGraphAPI('query', operationName='ListUntypedConfigurationRevisions', parameterNameTypeValues=parameterNameTypeValues, returnType='ListUntypedConfigurationRevisionsReturnValue', fields=fields, timeout=timeout)
    ...
    def QueryPacketCapture(
        ...
        """Query captured packets with pagination.

        Args:
            label (str): Label of the network interface to query captured packets for.
            limit (int): Maximum number of packets to return.
            offset (int): Packet index offset (0-based).
            fields (list or dict, optional): Specifies a subset of fields to return.
            timeout (float, optional): Number of seconds to wait for response.

        Returns:
            HypervisorPacketCaptureData: HypervisorPacketCaptureData is the result of querying captured packets with pagination
        """
        parameterNameTypeValues: List[Tuple[str, str, Any]] = [
            ('label', 'String!', label),
            ('limit', 'Int!', limit),
        ...
        return self._CallSimpleGraphAPI('query', operationName='QueryPacketCapture', parameterNameTypeValues=parameterNameTypeValues, returnType='HypervisorPacketCaptureData', fields=fields, timeout=timeout)
...
class GraphMutations:
    ...
    def CreateEnvironments(
        ...
        """Create multiple new environments.

        Args:
            environments ([EnvironmentInput]): Properties to be applied on the newly created environment.
            resolveReferences (bool, optional): Whether to operate on resolved bodies in the environment. Defaults to operate and return unresolved data.
            units (UnitSelectionInput, optional): Optional unit selection.
            fields (list or dict, optional): Specifies a subset of fields to return.
            timeout (float, optional): Number of seconds to wait for response.
        ...
        return self._CallSimpleGraphAPI('mutation', operationName='CreateEnvironments', parameterNameTypeValues=parameterNameTypeValues, returnType='Environment', fields=fields, timeout=timeout)
    ...
    def DeleteAllScheduleEvents(
        self,
        fields: Optional[Union[List[str], Dict[str, Any]]] = None,
        timeout: Optional[float] = None,
    ) -> None:
        """Delete all existing schedule events.
        ...
        """
        parameterNameTypeValues: List[Tuple[str, str, Any]] = []
        return self._CallSimpleGraphAPI('mutation', operationName='DeleteAllScheduleEvents', parameterNameTypeValues=parameterNameTypeValues, returnType='Void', fields=fields, timeout=timeout)
    ...
    def GenerateUniqueIdentifier(
        self,
        uniqueIdentifierGeneratorName: str,
        fields: Optional[Union[List[str], Dict[str, Any]]] = None,
        timeout: Optional[float] = None,
    ) -> str:
        ...
        Args:
            uniqueIdentifierGeneratorName (str): Name of the identifier generator.
            fields (list or dict, optional): Specifies a subset of fields to return.
            timeout (float, optional): Number of seconds to wait for response.
        ...
        """
        parameterNameTypeValues: List[Tuple[str, str, Any]] = [
            ('uniqueIdentifierGeneratorName', 'String!', uniqueIdentifierGeneratorName),
        ]
        return self._CallSimpleGraphAPI('mutation', operationName='GenerateUniqueIdentifier', parameterNameTypeValues=parameterNameTypeValues, returnType='String', fields=fields, timeout=timeout)
    ...
    def ModifyEnvironments(
        ...
        """Modify multiple existing environments.

        Args:
            environmentIds ([String]): IDs of the environments to modify.
            environments ([EnvironmentInput]): Properties to be modified on the existing environments.
            resolveReferences (bool, optional): Whether to operate on resolved bodies in the environment. Defaults to operate and return unresolved data.
            units (UnitSelectionInput, optional): Optional unit selection.
            fields (list or dict, optional): Specifies a subset of fields to return.
            timeout (float, optional): Number of seconds to wait for response.
        ...
        return self._CallSimpleGraphAPI('mutation', operationName='ModifyEnvironments', parameterNameTypeValues=parameterNameTypeValues, returnType='Environment', fields=fields, timeout=timeout)
...
It is highly recommended to backup the data before calling this api.
    ...
    def StartPacketCapture(
        ...
        Args:
            label (str): Label of the network interface to capture on.
            filter (str, optional): Optional BPF filter expression for tcpdump.
            packetLimit (int, optional): Maximum number of packets to capture.
            fields (list or dict, optional): Specifies a subset of fields to return.
            timeout (float, optional): Number of seconds to wait for response.
        ...
        parameterNameTypeValues: List[Tuple[str, str, Any]] = [
            ...
            ('packetLimit', 'Int', packetLimit),
        ]
        return self._CallSimpleGraphAPI('mutation', operationName='StartPacketCapture', parameterNameTypeValues=parameterNameTypeValues, returnType='Void', fields=fields, timeout=timeout)
    ...
    def StopPacketCapture(
        ...
        Args:
            label (str): Label of the network interface to stop capturing on.
            fields (list or dict, optional): Specifies a subset of fields to return.
            timeout (float, optional): Number of seconds to wait for response.
        ...
        return self._CallSimpleGraphAPI('mutation', operationName='StopPacketCapture', parameterNameTypeValues=parameterNameTypeValues, returnType='Void', fields=fields, timeout=timeout)
