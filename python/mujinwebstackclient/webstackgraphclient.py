...
# GENERATED AGAINST: mujinwebstack/2.28.25+babc6bd22e67d8f9586ebb2d14f5aa7977f42e0a
#
...
class GraphQueries:
    ...
    def CompareEnvironment(self, environmentId, referenceEnvironmentId, resolveReferences=None, units=None, fields=None, timeout=None):
        """Compare two environment.

        Args:
            environmentId (str): ID of the environment
            referenceEnvironmentId (str): ID of the reference environment
        ...
        parameterNameTypeValues = [
            ...
            ('referenceEnvironmentId', 'String!', referenceEnvironmentId),
            ('resolveReferences', 'Boolean', resolveReferences),
            ('units', 'UnitSelectionInput', units),
        ]
        return self._CallSimpleGraphAPI('query', operationName='CompareEnvironment', parameterNameTypeValues=parameterNameTypeValues, returnType='Environment', fields=fields, timeout=timeout)
    ...
    def ExistApplicationConfiguration(self, configurationId, applicationId=None, resolveReferences=None, fields=None, timeout=None):
    ...
    def ExistApplicationConfigurations(self, configurationIds, applicationId=None, resolveReferences=None, fields=None, timeout=None):
    ...
    def GetApplicationConfiguration(self, configurationId, applicationId=None, resolveReferences=None, fields=None, timeout=None):
    ...
    def GetApplicationControllerSystemConfiguration(self, applicationId=None, resolveReferences=None, fields=None, timeout=None):
        """Get application configurations for controller system.
        ...
        return self._CallSimpleGraphAPI('query', operationName='GetApplicationControllerSystemConfiguration', parameterNameTypeValues=parameterNameTypeValues, returnType='ControllerSystemConfiguration', fields=fields, timeout=timeout)

    def GetApplicationOrchestratorMasterConfiguration(self, applicationId=None, resolveReferences=None, fields=None, timeout=None):
        """Get application configurations for orchestrator master.
        ...
        return self._CallSimpleGraphAPI('query', operationName='GetApplicationOrchestratorMasterConfiguration', parameterNameTypeValues=parameterNameTypeValues, returnType='OrchestratorMasterConfiguration', fields=fields, timeout=timeout)

    def GetApplicationRobotBridgesConfiguration(self, applicationId=None, resolveReferences=None, fields=None, timeout=None):
        """Get application configurations for robotbridges.
        ...
        return self._CallSimpleGraphAPI('query', operationName='GetApplicationRobotBridgesConfiguration', parameterNameTypeValues=parameterNameTypeValues, returnType='RobotBridgesConfiguration', fields=fields, timeout=timeout)

    def GetApplicationSensorBridgesConfiguration(self, applicationId=None, resolveReferences=None, fields=None, timeout=None):
        """Get application configurations for sensorbridges.
        ...
        return self._CallSimpleGraphAPI('query', operationName='GetApplicationSensorBridgesConfiguration', parameterNameTypeValues=parameterNameTypeValues, returnType='SensorBridgesConfiguration', fields=fields, timeout=timeout)

    def GetApplicationSignalMapConfiguration(self, configurationId, applicationId=None, resolveReferences=None, fields=None, timeout=None):
        """Get application signal map.
        ...
        return self._CallSimpleGraphAPI('query', operationName='GetApplicationSignalMapConfiguration', parameterNameTypeValues=parameterNameTypeValues, returnType='SignalMapConfiguration', fields=fields, timeout=timeout)
    ...
    def GetUntypedApplicationConfiguration(self, configurationId, applicationId=None, ifModifiedSinceModifiedAt=None, resolveReferences=None, fields=None, timeout=None):
    ...
    @UseLazyGraphQuery
    def ListApplicationConfigurations(self, applicationId=None, options=None, resolveReferences=None, fields=None, timeout=None):
    ...
    def UntypedCompareEnvironment(self, environmentId, referenceEnvironmentId, resolveReferences=None, units=None, fields=None, timeout=None):
        """Compare two environment.
        ...
        return self._CallSimpleGraphAPI('query', operationName='UntypedCompareEnvironment', parameterNameTypeValues=parameterNameTypeValues, returnType='Any', fields=fields, timeout=timeout)
...
class GraphMutations:
    ...
    def CopyApplicationConfiguration(self, configurationId, referenceConfigurationId, applicationId=None, resolveReferences=None, fields=None, timeout=None):
    ...
    def CopyApplicationSignalMapConfiguration(self, configurationId, referenceConfigurationId, applicationId=None, resolveReferences=None, fields=None, timeout=None):
        """Copy application signal map and return copied signal map.
        ...
        return self._CallSimpleGraphAPI('mutation', operationName='CopyApplicationSignalMapConfiguration', parameterNameTypeValues=parameterNameTypeValues, returnType='SignalMapConfiguration', fields=fields, timeout=timeout)
    ...
    def DeleteApplicationConfiguration(self, configurationId, applicationId=None, resolveReferences=None, fields=None, timeout=None):
    ...
    def MergeApplicationConfiguration(self, configurationId, content, applicationId=None, resolveReferences=None, fields=None, timeout=None):
    ...
    def MergeApplicationControllerSystemConfiguration(self, controllerSystemConfiguration, applicationId=None, resolveReferences=None, fields=None, timeout=None):
        """Update application configuration by merging a partial configuration into it.
        ...
        return self._CallSimpleGraphAPI('mutation', operationName='MergeApplicationControllerSystemConfiguration', parameterNameTypeValues=parameterNameTypeValues, returnType='ControllerSystemConfiguration', fields=fields, timeout=timeout)

    def MergeApplicationOrchestratorMasterConfiguration(self, orchestratorMasterConfiguration, applicationId=None, resolveReferences=None, fields=None, timeout=None):
        """Update application configuration by merging a partial configuration into it.
        ...
        return self._CallSimpleGraphAPI('mutation', operationName='MergeApplicationOrchestratorMasterConfiguration', parameterNameTypeValues=parameterNameTypeValues, returnType='OrchestratorMasterConfiguration', fields=fields, timeout=timeout)

    def MergeApplicationRobotBridgesConfiguration(self, robotBridgesConfiguration, applicationId=None, resolveReferences=None, fields=None, timeout=None):
        """Update application configuration by merging a partial configuration into it.
        ...
        return self._CallSimpleGraphAPI('mutation', operationName='MergeApplicationRobotBridgesConfiguration', parameterNameTypeValues=parameterNameTypeValues, returnType='RobotBridgesConfiguration', fields=fields, timeout=timeout)

    def MergeApplicationSensorBridgesConfiguration(self, sensorBridgesConfiguration, applicationId=None, resolveReferences=None, fields=None, timeout=None):
        """Update application configuration by merging a partial configuration into it.
        ...
        return self._CallSimpleGraphAPI('mutation', operationName='MergeApplicationSensorBridgesConfiguration', parameterNameTypeValues=parameterNameTypeValues, returnType='SensorBridgesConfiguration', fields=fields, timeout=timeout)

    def MergeApplicationSignalMapConfiguration(self, configurationId, signalMapConfiguration, applicationId=None, resolveReferences=None, fields=None, timeout=None):
        """Update application signal map by merging a partial signal map into it.
        ...
        return self._CallSimpleGraphAPI('mutation', operationName='MergeApplicationSignalMapConfiguration', parameterNameTypeValues=parameterNameTypeValues, returnType='SignalMapConfiguration', fields=fields, timeout=timeout)
    ...
    def MergeUntypedApplicationConfiguration(self, configurationId, content, applicationId=None, resolveReferences=None, fields=None, timeout=None):
    ...
    def SetUntypedApplicationConfiguration(self, configurationId, content, applicationId=None, resolveReferences=None, fields=None, timeout=None):
