...
# GENERATED AGAINST: mujinwebstack/2.8.0+19097975ef42dc79c4b6ffe60a21f8f570646206
#
...
class GraphQueries:
    ...
    @UseLazyGraphQuery
    def ListGroups(self, aggregations=None, first=None, offset=None, fields=None, timeout=None):
        """List user groups.

        Args:
            aggregations ([StageInput], optional): Aggregation stages.
            first (int, optional): Limit the returned results to first few.
            offset (int, optional): Offset the returned results, skip amount specified by offset.
            fields (list or dict, optional): Specifies a subset of fields to return.
            timeout (float, optional): Number of seconds to wait for response.
        ...
        """
        parameterNameTypeValues = [
            ('aggregations', '[StageInput!]', aggregations),
            ('first', 'Int', first),
            ('offset', 'Int', offset),
        ]
    ...
    @UseLazyGraphQuery
    def ListRoles(self, aggregations=None, first=None, offset=None, fields=None, timeout=None):
        """List group roles.
    ...
    @UseLazyGraphQuery
    def ListUsers(self, aggregations=None, first=None, offset=None, fields=None, timeout=None):
...
class GraphMutations:
    ...
    def Logout(self, token, fields=None, timeout=None):
        """Logout a user, invalidate a json web token.
        ...
        return self._CallSimpleGraphAPI('mutation', operationName='Logout', parameterNameTypeValues=parameterNameTypeValues, returnType='Boolean', fields=fields, timeout=timeout)
    ...
    def MergeConfiguration(self, configurationId, content, resolveReferences=None, units=None, fields=None, timeout=None):
