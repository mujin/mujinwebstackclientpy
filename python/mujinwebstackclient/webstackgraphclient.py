...
# GENERATED AGAINST: mujinwebstack/2.3.40.48353eeeedab3fcea3edcf563f1a943e2ebe05c4-dirty
#
...
class GraphMutations:
    ...
    def SyncConfigurationsFromRemote(self, remoteUrl, configurationIdPatterns=None, configurationIds=None, ignoreDownloadFailures=None, remotePassword=None, remoteUsername=None, fields=None, timeout=None):
        """Sync configurations from remote webstack.

        Args:
            remoteUrl (str): URL to remote webstack, e.g. "http://username:password@controller123".
            configurationIdPatterns ([String], optional): List of regular expression patterns to determine configuration IDs to download. If ConfigurationIDs is also provided, ConfigurationIDs take precedence.
            configurationIds ([String], optional): List of configuration IDs to download.
        ...
        parameterNameTypeValues = [
            ...
            ('configurationIdPatterns', '[String!]', configurationIdPatterns),
    ...
    def SyncConfigurationsToRemote(self, remoteUrl, configurationIdPatterns=None, configurationIds=None, ignoreUploadFailures=None, remotePassword=None, remoteUsername=None, fields=None, timeout=None):
        """Sync configurations to remote webstack.

        Args:
            remoteUrl (str): URL to remote webstack, e.g. "http://username:password@controller123".
            configurationIdPatterns ([String], optional): List of regular expression patterns to determine configuration IDs to upload. If ConfigurationIDs is also provided, ConfigurationIDs take precedence.
            configurationIds ([String], optional): List of configuration IDs to upload.
