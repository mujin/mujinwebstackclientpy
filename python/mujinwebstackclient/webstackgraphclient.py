...
# GENERATED AGAINST: mujinwebstack/2.29.0+0a3c54bdbee3d1d4aa2893eea8c9bcfeb5b1e961
#
...
class GraphQueries:
    ...
    def DiffEnvironment(self, environmentId, referenceEnvironmentId, resolveReferences=None, units=None, fields=None, timeout=None):
        """Compare an environment with another environment and return the difference between.

        Args:
            environmentId (str): ID of the environment.
            referenceEnvironmentId (str): ID of the reference environment to use for comparison.
        ...
        return self._CallSimpleGraphAPI('query', operationName='DiffEnvironment', parameterNameTypeValues=parameterNameTypeValues, returnType='Environment', fields=fields, timeout=timeout)

    def DiffUntypedEnvironment(self, environmentId, referenceEnvironmentId, resolveReferences=None, units=None, fields=None, timeout=None):
        """Compare an environment with another environment and return the difference between them without typing.
        ...
        return self._CallSimpleGraphAPI('query', operationName='DiffUntypedEnvironment', parameterNameTypeValues=parameterNameTypeValues, returnType='Any', fields=fields, timeout=timeout)
