...
# GENERATED AGAINST: mujinwebstack/2.3.47.849a6aa54bac6bc137f3ed47932c59ed1dfe35d5-dirty
#
...
class GraphMutations:
    ...
    def DeleteReadables(self, bodyId, environmentId, resolveReferences=None, units=None, fields=None, timeout=None):
        """Modify an existing body readable interface in an environment.
        ...
        return self._CallSimpleGraphAPI('mutation', operationName='DeleteReadables', parameterNameTypeValues=parameterNameTypeValues, returnType='Void', fields=fields, timeout=timeout)
    ...
    def ModifyReadables(self, bodyId, environmentId, readables, resolveReferences=None, units=None, fields=None, timeout=None):
        """Modify an existing body readable interface in an environment.

        Args:
            bodyId (str): ID of the body to modify.
            environmentId (str): ID of the environment.
            readables (Any): Properties to be modified on the body.
            resolveReferences (bool, optional): Whether to operate on resolved bodies in the environment. Defaults to operate and return unresolved data.
            units (UnitSelectionInput, optional): Optional unit selection.
            fields (list or dict, optional): Specifies a subset of fields to return.
            timeout (float, optional): Number of seconds to wait for response.
        ...
        parameterNameTypeValues = [
            ('bodyId', 'String!', bodyId),
            ('environmentId', 'String!', environmentId),
            ('readables', 'Any!', readables),
            ('resolveReferences', 'Boolean', resolveReferences),
            ('units', 'UnitSelectionInput', units),
        ]
        return self._CallSimpleGraphAPI('mutation', operationName='ModifyReadables', parameterNameTypeValues=parameterNameTypeValues, returnType='Any', fields=fields, timeout=timeout)
