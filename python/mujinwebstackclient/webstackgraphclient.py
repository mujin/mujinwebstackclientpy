...
# GENERATED AGAINST: mujinwebstack/2.29.0+ee9253d3267be80902212e21f2b3b21ec74dc17e
#
...
class GraphMutations:
    ...
    def DeleteAllApplicationConfigurations(self, applicationId, resolveReferences=True, fields=None, timeout=None):
        """Delete all configurations belong to an application, returns the list of modified relative configuration ids.
