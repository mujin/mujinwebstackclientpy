...
# GENERATED AGAINST: mujinwebstack/2.9.0+f67ed7dd59415d9532f12f3d92716603c924e1d8
#
...
class GraphMutations:
    ...
    def ModifyLogEntry(self, logEntry, logEntryId, fields=None, timeout=None):
        """Modify an existing log entry.

        Args:
            logEntry (GenericLogEntryInput): Properties to be modified on the existing log entry.
            logEntryId (str): ID of the log entry to modify.
            fields (list or dict, optional): Specifies a subset of fields to return.
            timeout (float, optional): Number of seconds to wait for response.
        ...
        """
        parameterNameTypeValues = [
            ('logEntry', 'GenericLogEntryInput!', logEntry),
            ('logEntryId', 'String!', logEntryId),
        ]
        return self._CallSimpleGraphAPI('mutation', operationName='ModifyLogEntry', parameterNameTypeValues=parameterNameTypeValues, returnType='LogEntry', fields=fields, timeout=timeout)
