...
# GENERATED AGAINST: mujinwebstack/2.35.11+24dce7c6f1f8ee76f5e2a2cda702e733d7baad7e
#
...
class GraphSubscriptions:
    ...
    def SubscribeUntypedCloudAgentState(
        self,
        callbackFunction: Callable[[Optional[Any], Optional[Dict[str, Any]]], None],
        interval: str = '5s',
        fields: Optional[Union[List[str], Dict[str, Any]]] = None,
        ...
        return self._CallSubscribeGraphAPI(operationName='SubscribeUntypedCloudAgentState', parameterNameTypeValues=parameterNameTypeValues, returnType='Any', callbackFunction=callbackFunction, fields=fields)
