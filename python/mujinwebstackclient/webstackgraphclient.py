...
# GENERATED AGAINST: mujinwebstack/2.2.58.bfdca53acf2da854d2e08ab216537eef1a7948fc
#
...
class GraphQueries:
    ...
    def GetModule(self, moduleId, fields=None, timeout=None):
        ...
        Returns:
            Module: An module entry within the modules
        """
        parameterNameTypeValues = [
            ('moduleId', 'String!', moduleId),
        ]
        return self._CallSimpleGraphAPI('query', operationName='GetModule', parameterNameTypeValues=parameterNameTypeValues, returnType='Module', fields=fields, timeout=timeout)
