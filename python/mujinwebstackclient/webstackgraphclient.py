...
# GENERATED AGAINST: mujinwebstack/2.17.28+1a0925c8b79829eb8fb72e49e7cdac6de105a7af
#
...
class GraphQueries:
    ...
    def GetControllerTerminalModuleByControllerTerminalType(self, controllerTerminalType, fields=None, timeout=None):
        """Get controller terminal module by device type.

        Args:
            controllerTerminalType (str): 
            fields (list or dict, optional): Specifies a subset of fields to return.
            timeout (float, optional): Number of seconds to wait for response.

        Returns:
            ControllerTerminalModule: Controller terminal module library type.
        """
        parameterNameTypeValues = [
            ('controllerTerminalType', 'String!', controllerTerminalType),
        ]
        return self._CallSimpleGraphAPI('query', operationName='GetControllerTerminalModuleByControllerTerminalType', parameterNameTypeValues=parameterNameTypeValues, returnType='ControllerTerminalModule', fields=fields, timeout=timeout)
    ...
    def GetPendantState(self, fields=None, timeout=None):
    ...
    def GetPendantVersion(self, fields=None, timeout=None):
    ...
    def ListAncestorLogEntries(self, logEntryId, ancestorLogTypes=None, options=None, fields=None, timeout=None):
        ...
        Returns:
            ListAncestorLogEntriesReturnValue: 
        """
        parameterNameTypeValues = [
            ('logEntryId', 'String!', logEntryId),
        ...
        return self._CallSimpleGraphAPI('query', operationName='ListAncestorLogEntries', parameterNameTypeValues=parameterNameTypeValues, returnType='ListAncestorLogEntriesReturnValue', fields=fields, timeout=timeout)
    ...
    @UseLazyGraphQuery
    def ListControllerTerminalModules(self, options=None, fields=None, timeout=None):
        """List controller terminal modules.
        ...
        Returns:
            ListControllerTerminalModulesReturnValue: 
        """
        parameterNameTypeValues = [
            ('options', 'ListOptionsInput', options),
        ]
        return self._CallSimpleGraphAPI('query', operationName='ListControllerTerminalModules', parameterNameTypeValues=parameterNameTypeValues, returnType='ListControllerTerminalModulesReturnValue', fields=fields, timeout=timeout)
    ...
    def ListDescendantLogEntries(self, logEntryId, descendantLogTypes=None, options=None, fields=None, timeout=None):
        ...
        Returns:
            ListDescendantLogEntriesReturnValue: 
        """
        parameterNameTypeValues = [
            ('logEntryId', 'String!', logEntryId),
        ...
        return self._CallSimpleGraphAPI('query', operationName='ListDescendantLogEntries', parameterNameTypeValues=parameterNameTypeValues, returnType='ListDescendantLogEntriesReturnValue', fields=fields, timeout=timeout)
    ...
    def ListReferencedLogEntries(self, logEntryId, logTypes=None, options=None, fields=None, timeout=None):
        ...
        return self._CallSimpleGraphAPI('query', operationName='ListReferencedLogEntries', parameterNameTypeValues=parameterNameTypeValues, returnType='ListAncestorLogEntriesReturnValue', fields=fields, timeout=timeout)
    ...
    def ListReferencingLogEntries(self, logEntryId, logTypes=None, options=None, fields=None, timeout=None):
        ...
        return self._CallSimpleGraphAPI('query', operationName='ListReferencingLogEntries', parameterNameTypeValues=parameterNameTypeValues, returnType='ListDescendantLogEntriesReturnValue', fields=fields, timeout=timeout)
    ...
    @UseLazyGraphQuery
    def ListStatEntriesEx(self, disableOriginClustering=None, endedAt=None, intervalType=None, options=None, startedAt=None, statTypes=None, fields=None, timeout=None):
...
class GraphMutations:
    ...
    def BeepPendantBuzzer(self, duration=None, period=None, pulse=None, fields=None, timeout=None):
    ...
    def RemoveControllerTerminal(self, address, fields=None, timeout=None):
        """Remove a controller terminal from the system.
        ...
        return self._CallSimpleGraphAPI('mutation', operationName='RemoveControllerTerminal', parameterNameTypeValues=parameterNameTypeValues, returnType='Void', fields=fields, timeout=timeout)
    ...
    def SetPendantBuzzerOn(self, on=None, fields=None, timeout=None):
    ...
    def SetPendantDisplayBrightness(self, displayBrightness=None, fields=None, timeout=None):
    ...
    def SetPendantDisplayOn(self, on=None, fields=None, timeout=None):
    ...
    def SetPendantDisplayTTY(self, displayTty, fields=None, timeout=None):
    ...
    def SetPendantTouchscreenModes(self, gloveMode, singleTouchMode, fields=None, timeout=None):
