...
# GENERATED AGAINST: mujinwebstack/2.17.11+c91f4948abde45ff12e3f4ad2f7d469f8dc8abd4
#
...
class GraphQueries:
    ...
    @UseLazyGraphQuery
    def ListStatEntriesEx(self, endedAt=None, intervalType=None, options=None, skipOriginAggregation=None, startedAt=None, statTypes=None, fields=None, timeout=None):
        ...
        Args:
            ...
            options (ListOptionsWithAggregationsInput, optional): 
            skipOriginAggregation (bool, optional): If true, skip aggregating stat entries from different origins.
            startedAt (DateTime, optional): The time from which statistics entries are requested. Statistics will be returned from the interval that includes this time. For example, a request for hourly data starting from 12:30 will return hourly data starting from 12:00.
        ...
        parameterNameTypeValues = [
            ...
            ('options', 'ListOptionsWithAggregationsInput', options),
            ('skipOriginAggregation', 'Boolean', skipOriginAggregation),
            ('startedAt', 'DateTime', startedAt),
