...
# GENERATED AGAINST: mujinwebstack/2.5.1+5b9799383ee82c60a5e870e8c7752b75042e5491
#
...
class GraphQueries:
    ...
    def GetOrchestratorMasterConfiguration(self, resolveReferences=None, units=None, fields=None, timeout=None):
    ...
    def ListOrchestratorConfigurations(self, options=None, resolveReferences=None, units=None, fields=None, timeout=None):
        """List orchestrator specific configurations.
        ...
        Returns:
            ListOrchestratorConfigurationsReturnValue: 
        """
        parameterNameTypeValues = [
            ('options', 'ListOptionsInput', options),
            ('resolveReferences', 'Boolean', resolveReferences),
        ...
        return self._CallSimpleGraphAPI('query', operationName='ListOrchestratorConfigurations', parameterNameTypeValues=parameterNameTypeValues, returnType='ListOrchestratorConfigurationsReturnValue', fields=fields, timeout=timeout)
...
class GraphMutations:
    ...
    def CommandBaseSystemOrchestrator(self, orchestratorId, fields=None, timeout=None):
        ...
        return self._CallSimpleGraphAPI('mutation', operationName='CommandBaseSystemOrchestrator', parameterNameTypeValues=parameterNameTypeValues, returnType='BaseSystemOrchestratorServices', fields=fields, timeout=timeout)

    def CommandCalibrationOrchestrator(self, orchestratorId, fields=None, timeout=None):
        parameterNameTypeValues = [
            ('orchestratorId', 'String!', orchestratorId),
        ]
        return self._CallSimpleGraphAPI('mutation', operationName='CommandCalibrationOrchestrator', parameterNameTypeValues=parameterNameTypeValues, returnType='CalibrationOrchestratorServices', fields=fields, timeout=timeout)

    def CommandOrchestratorMaster(self, fields=None, timeout=None):
        parameterNameTypeValues = [
        ]
        return self._CallSimpleGraphAPI('mutation', operationName='CommandOrchestratorMaster', parameterNameTypeValues=parameterNameTypeValues, returnType='OrchestratorMasterServices', fields=fields, timeout=timeout)

    def CommandOrderCycleOrchestrator(self, orchestratorId, fields=None, timeout=None):
        parameterNameTypeValues = [
            ('orchestratorId', 'String!', orchestratorId),
        ]
        return self._CallSimpleGraphAPI('mutation', operationName='CommandOrderCycleOrchestrator', parameterNameTypeValues=parameterNameTypeValues, returnType='OrderCycleOrchestratorServices', fields=fields, timeout=timeout)

    def CommandPackingClusterOrchestrator(self, orchestratorId, fields=None, timeout=None):
        parameterNameTypeValues = [
            ('orchestratorId', 'String!', orchestratorId),
        ]
        return self._CallSimpleGraphAPI('mutation', operationName='CommandPackingClusterOrchestrator', parameterNameTypeValues=parameterNameTypeValues, returnType='PackingClusterOrchestratorServices', fields=fields, timeout=timeout)
    ...
    def CommandRegistrationOrchestrator(self, orchestratorId, fields=None, timeout=None):
        ...
        return self._CallSimpleGraphAPI('mutation', operationName='CommandRegistrationOrchestrator', parameterNameTypeValues=parameterNameTypeValues, returnType='RegistrationOrchestratorServices', fields=fields, timeout=timeout)
