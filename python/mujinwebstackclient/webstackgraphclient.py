...
class GraphQueries:
    ...
    @UseLazyGraphQuery
    def ListAllLogEntriesSchemaInfo(
        self,
        fields: Optional[Union[List[str], Dict[str, Any]]] = None,
        timeout: Optional[float] = None,
    ) -> Any:
        """List all implemented log entries schema info.
        ...
        Returns:
            ListAllLogEntriesSchemaInfoReturnValue:
        """
        parameterNameTypeValues: List[Tuple[str, str, Any]] = []
        return self._CallSimpleGraphAPI('query', operationName='ListAllLogEntriesSchemaInfo', parameterNameTypeValues=parameterNameTypeValues, returnType='ListAllLogEntriesSchemaInfoReturnValue', fields=fields, timeout=timeout)
