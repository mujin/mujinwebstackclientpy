...
# GENERATED AGAINST: mujinwebstack/2.9.0+38f0400ee8f4d15d65d4a3425715a5cac86198fc
#
...
class GraphQueries:
    ...
    @UseLazyGraphQuery
    def ListLogEntriesV2(self, options=None, fields=None, timeout=None):
        ...
        return self._CallSimpleGraphAPI('query', operationName='ListLogEntriesV2', parameterNameTypeValues=parameterNameTypeValues, returnType='ListLogEntriesReturnValue', fields=fields, timeout=timeout)
    ...
    @UseLazyGraphQuery
    def ListReferencedLogEntries(self, logEntryId, options=None, fields=None, timeout=None):
    ...
    @UseLazyGraphQuery
    def ListReferencingLogEntries(self, logEntryId, options=None, fields=None, timeout=None):
    ...
    @UseLazyGraphQuery
    def ListUntypedLogEntries(self, options=None, fields=None, timeout=None):
